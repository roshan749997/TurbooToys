  ...
  const socialLinks = [
    {
      ...
      url: 'https://facebook.com/turbootoys',
    },
    {
      name: 'Instagram',
      icon: (
      ...
      url: 'https://instagram.com/turbootoys',
    },
    {
      name: 'Pinterest',
      icon: (
      ...
      url: 'https://pinterest.com/turbootoys',
    },
    {
      name: 'YouTube',
      icon: (
      ...
      url: 'https://youtube.com/@turbootoys',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <p className="text-gray-300 text-sm mb-2">
            © {currentYear} <span className="font-semibold text-white">TurbooToys</span>. All rights reserved.
          </p>
